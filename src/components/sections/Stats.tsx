...
export default function Stats() {
  ...
  return (
    <section className="w-full bg-[#111111] border-y border-white/[0.06] relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none" style={{ background: 'radial-gradient(ellipse at center, rgba(216,251,50,0.06) 0%, rgba(216,251,50,0.02) 40%, transparent 70%)' }} />
        ...
        >
          {STAT_ITEMS.map((stat, i) => (
            <StaggerItem key={stat.key} className="text-center relative">
              <div className="text-3xl sm:text-5xl lg:text-6xl font-black text-[#D8FB32] tracking-[-2px] mb-2 font-sans" style={{ textShadow: '0 0 40px rgba(216,251,50,0.35), 0 0 80px rgba(216,251,50,0.15), 0 2px 4px rgba(0,0,0,0.3)' }}>
                {stat.value}
              </div>
