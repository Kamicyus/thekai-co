...
const EN_ROUTES = [
  ...
  { path: "/en/araclar/qr-kod", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/kelime-sayaci", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/sifre-olusturucu", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/renk-cevirici", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/bmi-hesaplayici", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/harf-cevirici", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/json-formatlayici", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/yuzde-hesaplayici", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/gorsel-boyutlandirma", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/yas-hesaplayici", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/tuner", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/metronom", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/bpm-bulucu", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/base64", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/lorem-ipsum", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/pomodoro", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/regex-test", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/renk-paleti", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/metin-farki", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/rapor-olusturucu", changeFrequency: "monthly" as const, priority: 0.6 },
  { path: "/en/araclar/youtube-bpm-analiz", changeFrequency: "monthly" as const, priority: 0.6 },
